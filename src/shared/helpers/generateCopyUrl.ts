...
export const generateCopyIncognitoUrl = (
  ...
  console.log("generateCopyIncognitoUrl", url);
  ...
  if (window.location.hostname.includes("multiaudioplayer")) {
    console.log(
      "generateCopyIncognitoUrl yes",
      url,
      getBasePrefix(),
      `${window.location.protocol}//${url}${getBasePrefix()}?${type}Id=${id}`,
    );
...
export const generateCopyUrl = (
  ...
  type: "track" | "playlist",
    ...
    console.log("generateCopyUrl", window.location.hostname);
    if (
      ...
      window.location.hostname.includes("multiaudioplayer")
        ...
        console.log(
          "generateCopyUrl yes",
          `${window.location.protocol}//${window.location.host}?${type}Id=${id}`,
        );
